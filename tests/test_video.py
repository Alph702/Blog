...
def test_create_post_with_video(admin_logged_in_page: Page, flask_app_url):
    ...
    expect(page.locator(".toast-success")).to_be_visible(timeout=300000)
    ...
    expect(video_player).to_be_visible(timeout=300000)
    ...
    expect(page.locator(f".post:has-text('{test_title}')")).not_to_be_visible(timeout=300000)
...
def test_edit_post_to_add_video(admin_logged_in_page: Page, flask_app_url):
    ...
    expect(page.locator(".video-player")).not_to_be_visible(timeout=300000) # No video initially
    ...
    page.goto(f"{flask_app_url}/post/{post_id}", timeout=300000)
