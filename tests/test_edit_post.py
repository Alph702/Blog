...
def test_edit_post_update_with_new_image(admin_logged_in_page: Page, flask_app_url):
    ...
    page.locator("a", has_text=test_title).click()
    expect(page.locator("img[alt='Post Image']")).to_be_visible(timeout=600000)
...
def test_edit_non_existent_post(admin_logged_in_page: Page, flask_app_url):
    ...
    page.goto(f"{flask_app_url}/edit/{non_existent_post_id}", timeout=600000)
    expect(page.locator(".toast-body")).to_have_text("Post not found.", timeout=600000)
